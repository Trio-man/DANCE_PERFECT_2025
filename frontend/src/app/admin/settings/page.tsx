        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col sm:flex-row gap-5 items-start bg-slate-50/50 border border-slate-200/60 p-4 rounded-xl">
            ...
            <div className="flex-1 space-y-3 w-full">
              ...
              {row.logo_url && (
                <div className="flex items-center gap-2">
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-slate-100 border border-slate-200/80 text-slate-600 rounded-md font-mono text-[10px] font-bold tracking-wide shadow-2xs">
                    <span className="text-slate-400 select-none">📦 STORAGE_BUCKET://Logos/</span>
                    <span className="text-slate-800 truncate max-w-[220px] sm:max-w-md">
                      {row.logo_url.split('/').pop()}
                    </span>
                  </div>
                </div>
              )}
