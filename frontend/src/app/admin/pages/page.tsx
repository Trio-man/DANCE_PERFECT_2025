...
import { FiFileText, FiAlertCircle, FiSave, FiCornerUpLeft, FiCheckCircle } from 'react-icons/fi';
  ...
  return (
    <div className="space-y-6 w-full">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-2 border-b border-slate-100">
        <div>
          <h1 className="text-xl font-bold text-slate-900 tracking-tight">Content Pages</h1>
        </div>
        <button
        ...
        {selected ? (
          <div className="md:col-span-2 bg-white border border-slate-200 rounded-xl p-5 md:p-6 shadow-sm space-y-4">
            ...
            <div className="pb-3 border-b border-slate-100 flex items-center justify-between">
              <div>
                <span className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Page Route</span>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-slate-700">Page Content</label>
              <textarea
                value={selected.body}
            ...
            <div className="pt-2">
              <label className="inline-flex items-center gap-2.5 cursor-pointer select-none">
                ...
                <div className="flex flex-col">
                  <span className="text-xs font-bold text-slate-800">Publish Publicly</span>
                  <span className="text-[11px] text-slate-400 font-normal">Make this page accessible to public users.</span>
                </div>
              </label>
            </div>
          ...
          <div className="md:col-span-2 border border-dashed border-slate-200 rounded-xl p-12 text-center text-slate-400 text-xs font-medium">
            Select a page from the list to begin editing.
          </div>
        )}
